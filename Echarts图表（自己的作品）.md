    ...
    xAxis: [{
        ...
        },
        {
            ...
            axisLabel: { //坐标轴刻度标签的相关设置
                ...
                margin: 20, //刻度标签与轴线之间的距离(文字到x轴的距离)
                textStyle: {
                    fontSize: 14,
                    fontWeight: '500',
                    color: function(param, index) {
...
![image-20210315155517393](./images/gEZl8Lu7tWzVdpf.webp)

```javascript
let num = "80%"
option = {
    backgroundColor: '#0B0CA3',
    title: [{
            text: num,
            x: '49.4%',
            y: '40%',
...
![image-20210315220149181](./images/QmUvJEy57x3adz9.webp)

```javascript
option = {
    backgroundColor: "#000332",
    title: {},
    //提示框
    tooltip: {},
    // 直角坐标系内绘图网格
                ...
                normal: {
                    ...
                    color: function(params) {
                        return {
                            ...
                            colorStops: [{
                                    offset: 0,
                                    color: "rgba(156, 0, 255,1)" // 0% 处的颜色
                                },
                                {
                                    offset: 1,
                                    color: "#F643F8" // 100% 处的颜色
                                }
                            ]
                        };
                    }
                ...
                normal: {
                    ...
                    color: function(params) {
                        return {
                            ...
                            colorStops: [{
                                    offset: 0,
                                    color: "rgba(14, 11, 161,1)" // 0% 处的颜色
                                },
                                {
                                    offset: 1,
                                    color: "#45D6F3" // 100% 处的颜色
                                }
                            ]
                        };
                    }
...
![image-20210316112350254](./images/nZOxT5p37V9MbHG.webp)
    ...
    series: [
        ...
        //点的旋转
        {
            ...
            renderItem: function(params, api) {
                ...
                //设置点的半径
                let r = Math.min(api.getWidth(), api.getHeight()) / 2 * .95;
...
function getCirlPoint(x0, y0, r, angle) {
    let x1 = x0 + r * Math.cos(angle * Math.PI / 360)
    let y1 = y0 + r * Math.sin(angle * Math.PI / 360)
    return {
        x: x1,
        y: y1
    }
